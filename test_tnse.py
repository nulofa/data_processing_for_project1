...
data = np.load('./data_rank_and_norm.npy')

#
# np.save('./data_rank_and_norm_float16.npy', data.astype('float16'))
# assert 1==9
data = data.reshape(-1,38313)
print(data.shape)
query = data[732]
...
#     team = data_tsne[i]
#     if i in top_30:
#         ax.scatter3D(team[0], team[1], team[2], c='r',s=5)
#         if i == 732:
#             ax.scatter(team[0], team[1], team[2], c='green', s=5)
#     else:
...
# plt.savefig('./fix.jpg', dpi=300,bbox_inches='tight')
